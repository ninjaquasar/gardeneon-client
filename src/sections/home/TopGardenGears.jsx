			...
			<div className="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
				<div className="border border-dark/10 dark:border-light/10 bg-stone-50 dark:bg-stone-800 p-6 rounded-3xl">
					...
					<div className="mt-6 space-y-2 text-lg">
						<p>
							<span className="font-bold">💵 Price:</span> $10.75
						</p>
						<p>
							<span className="font-bold">🔢 Quantity:</span> 12
						</p>
						<p>
							<span className="font-bold">💬 Good Reviews:</span> 11
						</p>
					</div>
				</div>
				<div className="border border-dark/10 dark:border-light/10 bg-stone-50 dark:bg-stone-800 p-6 rounded-3xl">
					...
					<div className="mt-6 space-y-2 text-lg">
						<p>
							<span className="font-bold">💵 Price:</span> $13.60
						</p>
						<p>
							<span className="font-bold">🔢 Quantity:</span> 16
						</p>
						<p>
							<span className="font-bold">💬 Good Reviews:</span> 16
						</p>
					</div>
				</div>
				<div className="border border-dark/10 dark:border-light/10 bg-stone-50 dark:bg-stone-800 p-6 rounded-3xl">
					...
					<div className="mt-6 space-y-2 text-lg">
						<p>
							<span className="font-bold">💵 Price:</span> $14.50
						</p>
						<p>
							<span className="font-bold">🔢 Quantity:</span> 6
						</p>
						<p>
							<span className="font-bold">💬 Good Reviews:</span> 8
						</p>
					</div>
				</div>
				<div className="border border-dark/10 dark:border-light/10 bg-stone-50 dark:bg-stone-800 p-6 rounded-3xl">
					...
					<div className="mt-6 space-y-2 text-lg">
						<p>
							<span className="font-bold">💵 Price:</span> $9.45
						</p>
						<p>
							<span className="font-bold">🔢 Quantity:</span> 14
						</p>
						<p>
							<span className="font-bold">💬 Good Reviews:</span> 13
						</p>
					</div>
				</div>
				<div className="border border-dark/10 dark:border-light/10 bg-stone-50 dark:bg-stone-800 p-6 rounded-3xl">
					...
					<div className="mt-6 space-y-2 text-lg">
						<p>
							<span className="font-bold">💵 Price:</span> $18.30
						</p>
						<p>
							<span className="font-bold">🔢 Quantity:</span> 5
						</p>
						<p>
							<span className="font-bold">💬 Good Reviews:</span> 12
						</p>
					</div>
				</div>
				<div className="border border-dark/10 dark:border-light/10 bg-stone-50 dark:bg-stone-800 p-6 rounded-3xl">
					...
					<div className="mt-6 space-y-2 text-lg">
						<p>
							<span className="font-bold">💵 Price:</span> $14.45
						</p>
						<p>
							<span className="font-bold">🔢 Quantity:</span> 18
						</p>
						<p>
							<span className="font-bold">💬 Good Reviews:</span> 16
						</p>
				...
				<div className="border border-dark/10 dark:border-light/10 bg-stone-50 dark:bg-stone-800 p-6 rounded-3xl">
					...
					<div className="mt-6 space-y-2 text-lg">
						<p>
							<span className="font-bold">💵 Price:</span> $70.40
						</p>
						<p>
							<span className="font-bold">🔢 Quantity:</span> 7
						</p>
						<p>
							<span className="font-bold">💬 Good Reviews:</span> 9
						</p>
					</div>
				</div>
				<div className="border border-dark/10 dark:border-light/10 bg-stone-50 dark:bg-stone-800 p-6 rounded-3xl">
					...
					<div className="mt-6 space-y-2 text-lg">
						...
						<p>
							<span className="font-bold">🔢 Quantity:</span> 20
						</p>
						<p>
							<span className="font-bold">💬 Good Reviews:</span> 18
						</p>
					</div>
				</div>
			</div>
