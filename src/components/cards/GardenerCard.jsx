const GardenerCard = ({ data, showStatus = false }) => {
	...
	return (
		<div
			className={`border border-dark/10 dark:border-light/10 bg-stone-50 dark:bg-stone-800 rounded-3xl px-6 py-8 hover:shadow-lg hover:shadow-dark/10 transition-shadow duration-200 text-lg ${
				showStatus ? "relative" : ""
			}`}
		>
